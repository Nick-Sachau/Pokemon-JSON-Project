...
function createMain(obj){
  ...
  img_char.setAttribute('src', 'charizard.png')
  img_char.setAttribute('width', '90%')
  img_char.setAttribute('alt', 'CHARIZARD')
...
// TYPE 2
    ARTICLE_type2 = document.createElement('article')
    ARTICLE_type2.setAttribute('id', 'type')
    H2_type2 = document.createElement('h2')
    DIV_type2 = document.createElement('div')
    DIV_type2.textContent = `Slot ${charObj['types'][1]['slot']} : ${charObj['types'][1]['type']['name']}`
    H2_type2.textContent = 'Type'
    ARTICLE_type2.appendChild(H2_type2)
    ARTICLE_type2.appendChild(DIV_type2)
// TYPE 2
